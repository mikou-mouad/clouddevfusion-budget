...
--------------------------------------------------------------- */
const SEED_PROJECTS = [{"id": "p1", "client": "Efrei", "contact": "Julien", "source": "Ilyes & Alexis", "trainer": "Ahmed Tahri", "topic": "Training", "name": "Efrei - Cloud Intro", "startDate": "2026-03-09", "endDate": "2026-03-13", "status": "Paid", "expectedAmount": 2765, "notes": ""}, {"id": "p2", "client": "IWG", "contact": "N/A", "source": "N/A", "trainer": "N/A", "topic": "Office", "name": "IWG - Office", "startDate": "2026-01-01", "endDate": "2026-01-31", "status": "Paid", "expectedAmount": 0, "notes": ""}, {"id": "p3", "client": "Efrei", "contact": "Julien", "source": "Ilyes & Alexis", "trainer": "Ahmed Tahri", "topic": "Training", "name": "Efrei - DP600 - Aug (1/2)", "startDate": "2026-07-06", "endDate": "2026-07-07", "status": "Signed", "expectedAmount": 1176, "notes": ""}, {"id": "p4", "client": "Efrei", "contact": "Julien", "source": "Ilyes & Alexis", "trainer": "Ahmed Tahri", "topic": "Training", "name": "Efrei - DP600 - Aug (2/2)", "startDate": "2026-08-31", "endDate": "2026-09-02", "status": "Signed", "expectedAmount": 1764, "notes": ""}, {"id": "p5", "client": "Efrei", "contact": "Julien", "source": "Ilyes & Alexis", "trainer": "Monaim Touinsi", "topic": "Training", "name": "Efrei - DP600 - Sep", "startDate": "2026-08-31", "endDate": "2026-09-04", "status": "Signed", "expectedAmount": 2940, "notes": ""}, {"id": "p6", "client": "Crossthink", "contact": "Arnaud", "source": "Ilyes & Alexis", "trainer": "Ahmed Tahri", "topic": "Training", "name": "Crossthink  - Apr - Week 1", "startDate": "2026-03-30", "endDate": "2026-04-03", "status": "Lost", "expectedAmount": 4750, "notes": ""}, {"id": "p7", "client": "Crossthink", "contact": "Arnaud", "source": "Ilyes & Alexis", "trainer": "Salahedine Bejaoui", "topic": "Training", "name": "Crossthink  - Apr - Week 2 & 3", "startDate": "2026-04-07", "endDate": "2026-04-17", "status": "Lost", "expectedAmount": 8550, "notes": ""}, {"id": "p8", "client": "Crossthink", "contact": "Arnaud", "source": "Ilyes & Alexis", "trainer": "Mouad MIKOU", "topic": "Training", "name": "Crossthink  - Apr - Week 4", "startDate": "2026-04-20", "endDate": "2026-04-24", "status": "Lost", "expectedAmount": 4750, "notes": ""}, {"id": "p9", "client": "FastLane", "contact": "Sarah Medjeber", "source": "N/A", "trainer": "Monaim Touinsi", "topic": "Training", "name": "FastLane - AZ204", "startDate": "2026-05-18", "endDate": "2026-05-22", "status": "Lost", "expectedAmount": 2300, "notes": ""}, {"id": "p10", "client": "FastLane", "contact": "Sarah Medjeber", "source": "N/A", "trainer": "Youssef ElGandouli", "topic": "Training", "name": "FastLane - AZ700", "startDate": "2026-04-07", "endDate": "2026-04-10", "status": "Lost", "expectedAmount": 1840, "notes": ""}, {"id": "p11", "client": "Cellenza", "contact": "Alain\u00a0GIANSILY", "source": "N/A", "trainer": "Mouad MIKOU", "topic": "Training", "name": "Cellenza - AZ500", "startDate": "2026-03-16", "endDate": "2026-03-19", "status": "Paid", "expectedAmount": 3000, "notes": ""}, {"id": "p12", "client": "Ichrak", "contact": "Ichrak", "source": "N/A", "trainer": "N/A", "topic": "Salary", "name": "Ichrak - Janvier", "startDate": "2026-01-01", "endDate": "2026-01-30", "status": "Paid", "expectedAmount": 0, "notes": ""}, {"id": "p13", "client": "Ichrak", "contact": "Ichrak", "source": "N/A", "trainer": "N/A", "topic": "Salary", "name": "Ichrak - Fevrier", "startDate": "2026-02-01", "endDate": "2026-02-28", "status": "Paid", "expectedAmount": 0, "notes": ""}, {"id": "p14", "client": "IWG", "contact": "N/A", "source": "N/A", "trainer": "N/A", "topic": "Office", "name": "IWG - Office", "startDate": "2026-02-01", "endDate": "2026-02-28", "status": "Paid", "expectedAmount": 0, "notes": ""}];
const SEED_PROJECTS_REST = [{"id": "p15", "client": "IWG", "contact": "N/A", "source": "N/A", "trainer": "N/A", "topic": "Office", "name": "IWG - Office", "startDate": "2026-03-01", "endDate": "2026-03-31", "status": "Paid", "expectedAmount": 0, "notes": ""}];

/* remaining rows appended programmatically-style to keep file readable */
const SEED_PROJECTS_ALL = SEED_PROJECTS.concat(SEED_PROJECTS_REST).concat([
  { id: "p16", client: "Efrei", contact: "Julien", source: "Ilyes & Alexis", trainer: "N/A", topic: "Training", name: "Efrei - Extra 1", startDate: "2026-05-01", endDate: "2026-05-02", status: "Invoiced", expectedAmount: 1500, notes: "" },
  { id: "p17", client: "Efrei", contact: "Julien", source: "Ilyes & Alexis", trainer: "Oussama EDDAI", topic: "Training", name: "Efrei - Cloud Intro 2 (1/2)", startDate: "2027-01-04", endDate: "2027-01-05", status: "Signed", expectedAmount: 1176, notes: "" },
  { id: "p18", client: "Efrei", contact: "Julien", source: "Ilyes & Alexis", trainer: "Oussama EDDAI", topic: "Training", name: "Efrei - Cloud Intro 2 (2/2)", startDate: "2027-01-12", endDate: "2027-01-13", status: "Signed", expectedAmount: 1176, notes: "" },
  { id: "p19", client: "Efrei", contact: "Julien", source: "Ilyes & Alexis", trainer: "Oussama EDDAI or Monaim", topic: "Training", name: "Efrei - Cloud Intro 3", startDate: null, endDate: null, status: "Pipeline", expectedAmount: 2212, notes: "Trainer fee estimate 2000" },
  { id: "p20", client: "Efrei", contact: "Julien", source: "Ilyes & Alexis", trainer: null, topic: "Training", name: "Efrei - AZ104 - 1", startDate: null, endDate: null, status: "Pipeline", expectedAmount: 0, notes: "" },
  { id: "p21", client: "Efrei", contact: "Julien", source: "Ilyes & Alexis", trainer: null, topic: "Training", name: "Efrei - AZ104 - 2", startDate: null, endDate: null, status: "Pipeline", expectedAmount: 0, notes: "" },
  { id: "p22", client: "Efrei", contact: "Julien", source: "Ilyes & Alexis", trainer: null, topic: "Training", name: "Efrei - DP700 - 1", startDate: null, endDate: null, status: "Pipeline", expectedAmount: 0, notes: "" },
  { id: "p23", client: "Efrei", contact: "Julien", source: "Ilyes & Alexis", trainer: null, topic: "Training", name: "Efrei - DP700 - 2", startDate: null, endDate: null, status: "Pipeline", expectedAmount: 0, notes: "" },
]);

const SEED_EXPENSES = [
  { id: "e1", projectId: "p1", projectName: "Efrei - Cloud Intro", category: "Trainer Fee", date: "2026-03-09", status: "Paid", expectedAmount: 2150, notes: "" },
  { id: "e2", projectId: "p1", projectName: "Efrei - Cloud Intro", category: "Commission", date: "2026-03-09", status: "Paid", expectedAmount: 307.5, notes: "" },
  { id: "e3", projectId: "p2", projectName: "IWG - Office", category: "Office", date: "2026-01-01", status: "Paid", expectedAmount: 278.58, notes: "" },
  { id: "e4", projectId: "p3", projectName: "Efrei - DP600 - Aug (1/2)", category: "Trainer Fee", date: "2026-07-06", status: "Signed", expectedAmount: 860, notes: "" },
  { id: "e5", projectId: "p3", projectName: "Efrei - DP600 - Aug (1/2)", category: "Commission", date: "2026-07-06", status: "Signed", expectedAmount: 158, notes: "" },
  { id: "e6", projectId: "p4", projectName: "Efrei - DP600 - Aug (2/2)", category: "Trainer Fee", date: "2026-08-31", status: "Signed", expectedAmount: 1290, notes: "" },
  { id: "e7", projectId: "p4", projectName: "Efrei - DP600 - Aug (2/2)", category: "Commission", date: "2026-08-31", status: "Signed", expectedAmount: 237, notes: "" },
  { id: "e8", projectId: "p5", projectName: "Efrei - DP600 - Sep", category: "Trainer Fee", date: "2026-08-31", status: "Signed", expectedAmount: 2150, notes: "" },
  { id: "e9", projectId: "p5", projectName: "Efrei - DP600 - Sep", category: "Commission", date: "2026-08-31", status: "Signed", expectedAmount: 395, notes: "" },
  { id: "e10", projectId: "p6", projectName: "Crossthink  - Apr - Week 1", category: "Trainer Fee", date: "2026-03-30", status: "Lost", expectedAmount: 4000, notes: "" },
  { id: "e11", projectId: "p6", projectName: "Crossthink  - Apr - Week 1", category: "Commission", date: "2026-03-30", status: "Lost", expectedAmount: 375, notes: "" },
  { id: "e12", projectId: "p7", projectName: "Crossthink  - Apr - Week 2 & 3", category: "Trainer Fee", date: "2026-04-07", status: "Lost", expectedAmount: 4950, notes: "" },
  { id: "e13", projectId: "p7", projectName: "Crossthink  - Apr - Week 2 & 3", category: "Commission", date: "2026-04-07", status: "Lost", expectedAmount: 1800, notes: "" },
  { id: "e14", projectId: "p8", projectName: "Crossthink  - Apr - Week 4", category: "Trainer Fee", date: "2026-04-20", status: "Lost", expectedAmount: 4000, notes: "" },
  { id: "e15", projectId: "p8", projectName: "Crossthink  - Apr - Week 4", category: "Commission", date: "2026-04-20", status: "Lost", expectedAmount: 375, notes: "" },
  { id: "e16", projectId: "p9", projectName: "FastLane - AZ204", category: "Trainer Fee", date: "2026-05-18", status: "Lost", expectedAmount: 1750, notes: "" },
  { id: "e17", projectId: "p10", projectName: "FastLane - AZ700", category: "Trainer Fee", date: "2026-04-07", status: "Lost", expectedAmount: 1000, notes: "" },
  { id: "e18", projectId: "p10", projectName: "FastLane - AZ700", category: "Other Cost", date: "2026-04-07", status: "Lost", expectedAmount: 100, notes: "" },
  { id: "e19", projectId: "p11", projectName: "Cellenza - AZ500", category: "Trainer Fee", date: "2026-03-16", status: "Paid", expectedAmount: 2800, notes: "" },
  { id: "e20", projectId: "p12", projectName: "Ichrak - Janvier", category: "Salary", date: "2026-01-01", status: "Paid", expectedAmount: 200, notes: "" },
  { id: "e21", projectId: "p13", projectName: "Ichrak - Fevrier", category: "Salary", date: "2026-02-01", status: "Paid", expectedAmount: 300, notes: "" },
  { id: "e22", projectId: "p14", projectName: "IWG - Office", category: "Office", date: "2026-02-01", status: "Paid", expectedAmount: 69.2, notes: "" },
  { id: "e23", projectId: "p15", projectName: "IWG - Office", category: "Office", date: "2026-03-01", status: "Paid", expectedAmount: 186.9, notes: "" },
  { id: "e24", projectId: "p17", projectName: "Efrei - Cloud Intro 2 (1/2)", category: "Trainer Fee", date: "2027-01-04", status: "Signed", expectedAmount: 850, notes: "" },
  { id: "e25", projectId: "p18", projectName: "Efrei - Cloud Intro 2 (2/2)", category: "Trainer Fee", date: "2027-01-12", status: "Signed", expectedAmount: 850, notes: "" },
  { id: "e26", projectId: "p19", projectName: "Efrei - Cloud Intro 3", category: "Trainer Fee", date: null, status: "Pipeline", expectedAmount: 2000, notes: "" },
];
...
const EXPENSE_CATEGORIES = ["Trainer Fee", "Commission", "Other Cost", "Office", "Salary", "Software", "Travel", "Other"];
